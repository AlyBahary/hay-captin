...
class OrderAdapter(
    ...
    override fun getItemCount() =
        orders.data.size
//        if (type == Constants.ORDER) orders.orders.data.size else orders.subscription.data.size
    ...
    override fun onBindViewHolder(holder: OrdersViewHolder, position: Int) {
        ...
        //        else{
//            holder.binding.tvStatus.text = orders.subscription.data[position].payment_status
//            holder.binding.tvDate.text = orders.subscription.data[position].order_date
//            holder.binding.tvPrice.text =
//                orders.subscription.data[position].total_amount.toString() + " " + context.getString(R.string.rs)
//            holder.binding.tvLocation.text = ""
//            holder.binding.tvOrderNumber.text =
//                context.getString(R.string.order_hash) + orders.subscription.data[position].subscription_id
//            holder.binding.containerForOrder.setOnClickListener {
//                ordersView.openOrderDetails(orders.subscription.data[position].subscription_id.toString())
//            }
//
//        }
    }
